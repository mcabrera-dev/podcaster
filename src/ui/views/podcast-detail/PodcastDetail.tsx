...
function PodcastDetailView() {
  ...
  const getPodcastDetailtQry = useInjection<GetPodcastDetailtQry>(
    TYPES.GET_PODCAST_DETAIL_QRY
  );
  const getPodcastEpisodesQry = useInjection<GetPodcastEpisodesQry>(
    TYPES.GET_PODCAST_EPISODES_QRY
  );
  ...
  return (
    <div className="podcast-detail-container">
      {podcastDetail && (
        <PodcastSumary
          podcastDetail={{ ...podcastDetail, description: selected?.summary }}
        />
      )}
      <div className="podcast-chapters-list">
        <Routes>
          ...
          <Route
            ...
            element={podcastDetail ? <DetailsEpisode /> : <></>}
          />
        </Routes>
      </div>
    </div>
